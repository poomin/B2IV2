...
if($fn=='activeTrainings'){

    $input_status = $MMain->getInput('status');
    $input_note = $MMain->getInput('note');

    $result = $MTrain->editThis(['training_status'=>$input_status,'note'=>$input_note],['id'=>$this_training_id]);
