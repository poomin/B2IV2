...
require_once __DIR__.'/controller/trainingsEditController.php';
                ...
                <div class="p-0">
                    ...
                    <div class="text-center row pt-3">
                        <div class="offset-3 col-6">
                            <button class="btn btn-warning btn-block btn-lg" type="button" onclick="fnTrainingEdit()" > แก้ไขข้อมูล </button>
                        </div>
                    </div>
    ...
    function fnTrainingEdit() {
        ...
        if( trainingState==='' || trainingState===undefined  ){
            ...
            if(check){
                ...
                $(form).append(fnDomInput("fn","editTrainings"));
