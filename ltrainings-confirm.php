...
require_once __DIR__.'/controller/trainingsConfirmController.php';
            ...
            <div class="col-9 p-5 bg-white">
                ...
                <div class="p-0">
                    ...
                    <div class="text-center pt-3">
                        <h3 class="text-primary"><?php echo $this_pro_name;?></h3>
                        <h5 class="text-secondary"><?php echo $this_pro_name_en; ?></h5>
                    </div>
