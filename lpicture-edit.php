...
require_once __DIR__.'/controller/pictureEditController.php';
    ...
    <div class="pb-5 mb-5" style="margin-top: -80px;">
        ...
        <div class="row">
            ...
            <div class="col-9 p-5 bg-white">
                ...
                <div class="p-0">
                    <div class="row">
                        <?php foreach ($IMAGES as $key=>$item): ?>
                            <div class="col-3 p-2">
                                <div class="card">
                                    <img src="<?php echo $item['picture_path'];?>" class="card-img-top" alt="web image" >
                        ...
                        <div id="image">
                            <div class="box-img-ready">
                                <label class="rounded alert-info p-2" style="cursor: pointer;" for="file_image">
                                    ...
                                    <input id="file_image" web_id="<?php echo $SET_PIC_ID;?>" accept="image/*" type="file" style="display:none;" onchange="showLoadImage(this)">
                                </label>
                            </div>
                        </div>
                    </div>
                ...
                <div class="p-0">
                    <div class="mb-3">
                        <h5><u> รายละเอียดภาพกิจกรรม </u></h5>
                    </div>
                    <form method="post">
                        ...
                        <div class="text-center">
                            <input type="text" name="fn" value="editPicture" hidden>
