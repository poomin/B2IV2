...
require_once __DIR__.'/controller/processEditController.php';
                ...
                <div class="pr-5 pl-5">
                    <form class="form-validation" method="post" novalidate>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="name" value="<?php echo $this_pro_name;?>" required >
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="name_en" value="<?php echo $this_pro_name_en;?>" required >
                            <div class="invalid-feedback">
                        ...
                        <div class="pb-2" id="devShowStudentSelect">
                            ...
                            <div class="form-row pb-2" id="studentId<?php echo $item['user_id'];?>">
                                ...
                                <div class="col-4">
                                    <button class="btn btn-danger" type="button" onclick="deleteStudent('<?php echo $item['user_id'];?>');" >
                        ...
                        <div class="form-row pt-2 pb-3">
                            <div class="col-8">
                                <select id="selectStudentId" name="student_id" class="selectpicker form-control" data-live-search="true" title="Please select a Student ..." >
                        ...
                        <div class="form-group pt-3">
                            ...
                            <select class="form-control" id="idSchoolRegion" name="region">
                        ...
                        <div class="text-center pt-2">
                            ...
                            <button type="submit" class="btn btn-lg sr-button btn-warning" >UPDATE</button>
